...
try:
    ...
    exec(open(os.path.abspath('2.2 image_opencv_filtering.py'), encoding="utf8").read())
    print('2.2 image_opencv_filtering.py complete')
    exec(open(os.path.abspath('2.3 image_opencv_arithmetic.py'), encoding="utf8").read())
    print('2.3 image_opencv_arithmetic.py complete')
    exec(open(os.path.abspath('2.4 image_opencv_contours.py'), encoding="utf8").read())
    print('2.4 image_opencv_contours.py complete')
    ...
    exec(open(os.path.abspath('8. image_opencv_segmentation.py'), encoding="utf8").read())
    print('8. image_opencv_segmentation.py complete')
    exec(open(os.path.abspath('9. image_opencv_selfdrive_vehicle.py'), encoding="utf8").read())
    print('9. image_opencv_selfdrive_vehicle.py complete')
