...
os.chdir("/home/tamir/image-processing-course")
#%matplotlib inline
...
Show it as it is
show it in a grayscal
play with cutoff to get black and white image

show the datatype and dimensions of the image for each case
'''
