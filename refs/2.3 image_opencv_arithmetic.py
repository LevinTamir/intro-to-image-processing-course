...
# CW: You can see dark line. Correct that
#%% GrabCut Foreground
...
#%% Background subtraction using BackgroundSubtractor class

#Use any one techniques
...
while(capture_video.isOpened()):
    ...
    #Draw white rectangle in original image/frame and put frame count in that box
    cv2.rectangle(frame, (10, 2), (100,20), (255,255,255), -1)
    cv2.putText(frame, str(capture_video.get(cv2.CAP_PROP_POS_FRAMES)), (15, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5 , (0,0,0))

    #Show both
    cv2.imshow('Frame', frame)
    cv2.imshow('Fore ground mask', foregroundMask)
